	        ...
	        <div class="x-spoiler">
	            ...
	            <div class="spoil-box">
	                ...
	                <blockquote class="spoil-Untext">
	                    ...
	                    Если обмен соответствует требованиям - наш бот примет его в течение нескольких минут.<br><br>
	                    Если вы воспользуетесь отменой обмена (Trade Protection) уже после пополнения баланса, ваш аккаунт будет заблокирован на серверах, а баланс обнулён.
	                    <div class="btn-skins">
...
curcontent["skins_en"] = {
	...
	xcon: `<div class="skin-content">
	  <div class="warnings_skin">
	    ⚠️ Before sending skins, please review the trade requirements. Please note that the funds for the skins will be credited only to the account from which they were sent.
	  </div>
	  <div class="spoiler">
	    <div class="x-spoiler">
	      <input class="spoil-button" type="checkbox" tabindex="-1">
	      <div class="spoil-box">
	        <span class="spoil-close fa"></span>
	        <span class="spoil-open fa"></span>
	        <span class="spoil-head">How skin prices are determined</span><br>
	        <blockquote class="spoil-Untext">
	          After sending a trade offer to our bot, it will determine the price of each skin and credit the user balance with an amount equal to 80% of the average skin value over the last month on the Steam marketplace. For example, if the average skin value in the trade offer is 100 rubles, the user balance will be credited with 80 rubles.
	        </blockquote>
	      </div>
	    </div>
	    <div class="x-spoiler">
	      ...
	      <div class="spoil-box">
	        <span class="spoil-close fa"></span>
	        <span class="spoil-open fa"></span>
	        <span class="spoil-head">Trade requirements</span>
	        <blockquote class="spoil-Untext">
	          » You must not have any <a href="https://help.steampowered.com/ru/faqs/view/34A1-EA3F-83ED-54AB" target="_blank">trade hold</a><br>
	          » Only skins from <b>RUST</b> and <b>CS2</b> are accepted<br>
	          » There should not be more than 12 items in one exchange<br>
	          » The trade offer must not contain CS skins cheaper than <b>5₽</b><br>
	          » The balance will only be replenished for the account from which the skins were sent
	        </blockquote>
	      </div>
	    </div>
	    <div class="x-spoiler">
	      ...
	      <div class="spoil-box">
	        <span class="spoil-close fa"></span>
	        <span class="spoil-open fa"></span>
	        <span class="spoil-head">Start deposit with skins</span><br>
	        <blockquote class="spoil-Untext">
	          To refill the balance, you need to go to the trade page (by clicking the button below), select the skins you want to use for refill, click the "Start trade" button, and confirm the trade through the Steam mobile app.<br><br>
	          If the trade meets the requirements, our bot will accept it within a few minutes.<br><br>
	          If you use trade cancellation (Trade Protection) after topping up your balance, your account will be banned on the servers and your balance will be reset to zero.
	          <div class="btn-skins">
	            <a class="btn-skin" onclick="openNewWindow('https://steamcommunity.com/tradeoffer/new/?partner=1748662763&token=v8jR-Ezt');">Start trade</a>
	          </div>
	        </blockquote>
	      </div>
	    </div>
...
<div class="xbox_custom_kits" ><div class="serverheader">Кит "Уникальный" - <span>Откат 24ч</span></div>\
<div class="kit_set"><div class="kit-items">\
...
<div class="forms-oplata-grid">\
	<div class="container-oplata-btn">\
		<a class="container-oplata-box" id="qiwi-inp-other2">\
			...
			<div class="textContainer-oplata">\
				<span class="name-user">Карты & СБП (рф)</span>\
	...
	<form onsubmit="return moruneHandler(event)" class="qiwi-inp-form" id="fk-inp-form" method="get" target="_blank" action="https://pay.bloodrust.io/api/integrations/enot/pay-link">\
		<div class="qiwi-inp-oplata" id="qiwi-inp-other">\
			<div class="qiwi-widget-title">Криптовалюта<br><p>USDT, LTC, TRX +</p></div>\
...
<div class="forms-oplata-grid">\
	<div class="container-oplata-btn">\
		...
		<a class="container-oplata-box" id="qiwi-inp-other2">\
			<img alt="" src="https://i.imgur.com/izriuxq.png" class="icon-user-oplata">\
			<div class="textContainer-oplata">\
				<span class="name-user">Card & SBP (ru)</span>\
				<span class="category-user">Visa, Mastercard и Мир</span>\
			</div>\
		</a>\
...
const weapons = [
    ...
    { image: 'homingmissile.launcher', time: '6h' },
...
function moruneHandler(e){
	...
	if(inputfloat < 100 || inputfloat > 50000 || isNaN(inputfloat)){
		document.getElementById('fk-error-box').innerText = "От 100 до 50000 RUB";
		e.preventDefault();
		return false;
	}else{
